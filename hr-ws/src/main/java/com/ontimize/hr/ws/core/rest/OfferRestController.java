...
public class OfferRestController extends ORestController<IOfferService> {
    ...
    public EntityResult currentOffersSearch(@RequestBody Map<String, Object> req) {
        try {
            ...
            key.put(SQLStatementBuilder.ExtendedSQLConditionValuesProcessor.EXPRESSION_KEY,
                    this.searchBetween(OfferDao.ATTR_START_DATE));
    ...
    private SQLStatementBuilder.BasicExpression searchBetweenWithYear(String param, int year) {
        ...
        SQLStatementBuilder.BasicExpression bexp1 = new SQLStatementBuilder.BasicExpression(field, BasicOperator.MORE_EQUAL_OP, startDate);
